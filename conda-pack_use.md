...
(this code assumes you want to install _conda-pack_ in your _'base'_ environment. If you create a separate environment for it, then activate it before proceeding with the packing step)
...
```
rsync -Pavz --info=progress2 _user@domain:_/full_path_to_directory/ my_env.tar.gz
```
